  ...
  return (
    <Router>
      ...
      <div className="container">
        <Routes>
          <Route path="/" element={<div className="text-center mt-5"><h1 className="display-4 text-primary mb-4">Welcome to OctoFit Tracker</h1><p className="lead">Track your activities, join teams, and climb the leaderboard!</p></div>} />
